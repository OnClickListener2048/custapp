/**
 * Text box with focus color and clear function.
 * https://github.com/khaiql/react-native-progressive-input/blob/master/index.js
...
class ProgressiveInput extends Component {
    ...
    render() {
        return (
            <View style={[styles.container, this.state.style, this.props.style]}>
                <TextInput
    ...
    _onFocus() {
        ...
        this.setState({ style: styles.textinputFocused })
    }
    ...
    _onBlur() {
        ...
        this.setState({ style: styles.textinputUnfocused });
    }
}
