...
/*
*
* countingfalseenablefalseselfEnabletrue
 countingfalseenabletrueselfEnabletrue

 countingtrueenabletrueselfEnablefalse
* */
        const {onClick, style, textStyle, enable, disableColor} = this.props
        const {counting, timerTitle, selfEnable} = this.state

        console.log("counting" + counting + "enable" + enable + "selfEnable" + selfEnable);
        return (
            <TouchableOpacity activeOpacity={counting ? 1 : 0.8} onPress={() => {
                ...
                <View
                    ...
                    <Text
                        textAlign='right'
                        style={[{fontSize: 16}, textStyle, {color: counting ? "#333333" : enable ? "#333333" : "#999999" }]}>{timerTitle}</Text>
                </View>
            </TouchableOpacity>
        )
    }
