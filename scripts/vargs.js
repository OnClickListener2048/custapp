// 修改 Vargs(arguments) 方法签名为 Vargs(argumentsList), 修复错误: arguments is a reserved word in strict mode
//
// vargs.js
//
...
//   }
//
exports.Constructor = function Vargs(argumentsList) {
    this.array = Array.prototype.slice.call(argumentsList);
