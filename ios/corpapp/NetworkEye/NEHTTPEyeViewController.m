...
- (void)viewWillAppear:(BOOL)animated {
  ...
  for (NEHTTPModel *currenModel in httpRequests) {
//    NSLog(@"%@",currenModel.requestURLString);
    if ([currenModel.requestURLString containsString:@"https"]) {
      [arr addObject:currenModel];
    }
  }
  httpRequests = [NSArray arrayWithArray:arr];
